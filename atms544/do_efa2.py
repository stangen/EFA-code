...
import numpy as np
from EFA.nicks_files.operational_cfsv2 import get_cfsv2_ensemble
from datetime import datetime, timedelta
from mpl_toolkits.basemap import Basemap
import matplotlib.pyplot as plt
import EFA.efa_files.cfs_utilities_st as ut
import EFA.efa_files.madis_example.madis_utilities as mt
import time
import os
...
outfile = outdir+year+'-'+month+'-'+day+'_'+hour+'_'+ensemble_type+'.nc'
