...
#key west  
ob1 = Observation(value=101440, time=datetime(2017,9,6,3),lat=24.555,lon=278.248,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Miami
ob2 = Observation(value=101470, time=datetime(2017,9,6,3),lat=25.791,lon=279.684,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Tampa Bay
ob3 = Observation(value=101510, time=datetime(2017,9,6,3),lat=27.962,lon=277.46,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Tallahassee
ob4 = Observation(value=101440, time=datetime(2017,9,6,3),lat=30.393,lon=275.647,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Jacksonville
ob5 = Observation(value=101470, time=datetime(2017,9,6,3),lat=30.495,lon=278.306,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Birmingham
ob6 = Observation(value=101530, time=datetime(2017,9,6,3),lat=33.566,lon=273.255,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Charleston
ob7 = Observation(value=101330, time=datetime(2017,9,6,3),lat=32.899,lon=279.959,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#LIX Slidell
ob8 = Observation(value=101430, time=datetime(2017,9,6,3),lat=30.343,lon=270.178,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Jackson
ob9 = Observation(value=101490, time=datetime(2017,9,6,3),lat=32.334,lon=269.777,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Nashville
ob10 = Observation(value=101480, time=datetime(2017,9,6,3),lat=36.119,lon=273.311,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Havana
ob11 = Observation(value=101399, time=datetime(2017,9,6,3),lat=22.989,lon=277.591,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Guantanamo
ob12 = Observation(value=101360, time=datetime(2017,9,6,3),lat=19.911,lon=284.836,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#San Juan
ob13 = Observation(value=101170, time=datetime(2017,9,6,3),lat=18.45,lon=294.001,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Roosevelt Airport
ob14 = Observation(value=100599, time=datetime(2017,9,6,3),lat=17.497,lon=297.021,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Atlanta
ob15 = Observation(value=101380, time=datetime(2017,9,6,3),lat=33.640,lon=275.573,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)

#Z500 obs
#key west  
ob16 = Observation(value=5900, time=datetime(2017,9,6,0),lat=24.55,lon=278.21,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Miami
ob17 = Observation(value=5890, time=datetime(2017,9,6,0),lat=25.75,lon=279.62,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Tampa Bay
ob18 = Observation(value=5880, time=datetime(2017,9,6,0),lat=27.70,lon=277.6,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Tallahassee
ob19 = Observation(value=5870, time=datetime(2017,9,6,0),lat=30.45,lon=275.7,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Jacksonville
ob20 = Observation(value=5870, time=datetime(2017,9,6,0),lat=30.50,lon=278.3,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#BMX
ob21 = Observation(value=5820, time=datetime(2017,9,6,0),lat=33.16,lon=273.24,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Charleston
ob22 = Observation(value=5850, time=datetime(2017,9,6,0),lat=32.90,lon=279.97,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#LIX Slidell
ob23 = Observation(value=5870, time=datetime(2017,9,6,0),lat=30.34,lon=270.17,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Jackson
ob24 = Observation(value=5840, time=datetime(2017,9,6,0),lat=32.32,lon=269.92,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Nashville
ob25 = Observation(value=5770, time=datetime(2017,9,6,0),lat=36.25,lon=273.43,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Peachtree City (Atlanta)
ob26 = Observation(value=5830, time=datetime(2017,9,6,0),lat=33.36,lon=275.43,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Newport NC
ob27 = Observation(value=5850, time=datetime(2017,9,6,0),lat=34.78,lon=283.12,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Santo Domingo
ob28 = Observation(value=5930, time=datetime(2017,9,6,0),lat=18.43,lon=290.12,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#San Juan
ob29 = Observation(value=5900, time=datetime(2017,9,6,0),lat=18.43,lon=294.01,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Grantley Adams
ob30 = Observation(value=5870, time=datetime(2017,9,6,0),lat=13.07,lon=300.5,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
...
outfile = '/home/disk/hot/stangen/Documents/GEFS/posterior/' + \
            '2017090600/2017090600_21mem_10days_30obs_MSLP_Z500_efa.nc'
