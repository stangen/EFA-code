...
ob5 = Observation(value=5870, time=datetime(2017,9,6,0),lat=30.50,lon=278.3,
                  ...
                  error=10)
#BMX
ob6 = Observation(value=5820, time=datetime(2017,9,6,0),lat=33.16,lon=273.24,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Charleston
ob7 = Observation(value=5850, time=datetime(2017,9,6,0),lat=32.90,lon=279.97,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#LIX Slidell
ob8 = Observation(value=5870, time=datetime(2017,9,6,0),lat=30.34,lon=270.17,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Jackson
ob9 = Observation(value=5840, time=datetime(2017,9,6,0),lat=32.32,lon=269.92,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Nashville
ob10 = Observation(value=5770, time=datetime(2017,9,6,0),lat=36.25,lon=273.43,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
...
#key west  
ob11 = Observation(value=101440, time=datetime(2017,9,6,3),lat=24.555,lon=278.248,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Miami
ob12 = Observation(value=101470, time=datetime(2017,9,6,3),lat=25.791,lon=279.684,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Tampa Bay
ob13 = Observation(value=101510, time=datetime(2017,9,6,3),lat=27.962,lon=277.46,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Tallahassee
ob14 = Observation(value=101440, time=datetime(2017,9,6,3),lat=30.393,lon=275.647,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Jacksonville
ob15 = Observation(value=101470, time=datetime(2017,9,6,3),lat=30.495,lon=278.306,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Birmingham
ob16 = Observation(value=101530, time=datetime(2017,9,6,3),lat=33.566,lon=273.255,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Charleston
ob17 = Observation(value=101330, time=datetime(2017,9,6,3),lat=32.899,lon=279.959,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#LIX Slidell
ob18 = Observation(value=101430, time=datetime(2017,9,6,3),lat=30.343,lon=270.178,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Jackson
ob19 = Observation(value=101490, time=datetime(2017,9,6,3),lat=32.334,lon=269.777,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
#Nashville
ob20 = Observation(value=101480, time=datetime(2017,9,6,3),lat=36.119,lon=273.311,
                  obtype = 'MSLP', localize_radius=2000, assimilate_this=True,
                  error=34)
...
outfile = '/home/disk/hot/stangen/Documents/GEFS/posterior/' + \
            '2017090600/2017090600_21mem_10days_20obs_MSLP_Z5002_efa.nc'
