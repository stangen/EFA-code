...
#Ketchikan  
ob1 = Observation(value=290.95, time=datetime(2017,9,6,6),lat=55.356,lon=228.286, #101210
                  obtype = 'T2M', localize_radius=2000, assimilate_this=True,
                  error=0.3)
#Seatac
ob2 = Observation(value=294.85, time=datetime(2017,9,6,6),lat=47.445,lon=237.686, #101280
                  obtype = 'T2M', localize_radius=2000, assimilate_this=True,
                  error=0.3)
#Spokane
ob3 = Observation(value=295.35, time=datetime(2017,9,6,6),lat=47.621,lon=242.472, #101630
                  obtype = 'T2M', localize_radius=2000, assimilate_this=True,
                  error=0.3)
#Great Falls
...
outfile = '/home/disk/hot/stangen/Documents/GEFS/posterior/' + \
            '2017090600/2017090600_21mem_10days_20T2M_WC_efa.nc'
