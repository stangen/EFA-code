...
ob11 = Observation(value=5830, time=datetime(2017,9,6,0),lat=33.36,lon=275.43,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Newport NC
ob12 = Observation(value=5850, time=datetime(2017,9,6,0),lat=34.78,lon=283.12,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Santo Domingo
ob13 = Observation(value=5930, time=datetime(2017,9,6,0),lat=18.43,lon=290.12,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#San Juan
ob14 = Observation(value=5900, time=datetime(2017,9,6,0),lat=18.43,lon=294.01,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
#Grantley Adams
ob15 = Observation(value=5870, time=datetime(2017,9,6,0),lat=13.07,lon=300.5,
                  obtype = 'Z500', localize_radius=2000, assimilate_this=True,
                  error=10)
...
outfile = '/home/disk/hot/stangen/Documents/GEFS/posterior/' + \
            '2017090600/2017090600_21mem_10days_Z500_00Z_15obs_efa.nc'
