...
def create_fcst_netcdfs(date, mems=range(0,21)):
    ...
    analysis_pars = "':(HGT:500 mb|TMP:2 m above ground|PRMSL:mean sea level|PWAT|APCP:surface):'"
    ...
    indir = '/home/disk/hot/stangen/Documents/GEFS/analysis/feb2017/grib2'
    outdir = '/home/disk/hot/stangen/Documents/GEFS/analysis/feb2017/netcdf'
    
    # Loop through the desired members
    outfile = '{}/anl_precip{}.nc'.format(outdir,datestr)
#     Remove the file if it exists (otherwise -append won't work)
    ...
    #command = 'ls -1a {}/gfsanl_3_{}{:02d}{:02d}_{:02d}00_000.grb2'.format(indir,date.year,date.month,date.day,date.hour)
    ...
    for grb in files_no_utf8:
        ...
        command = command.format(grb,analysis_pars,exclude,outfile)
