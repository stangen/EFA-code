...
#$ -V
#$ -cwd
#$ -o out_files/stats_100_0$JOB_NAME$TASK_ID
#$ -e err_files/stats_100_0$JOB_NAME$TASK_ID
#$ -t 1-8
...
var5="0" #observation error variance of ob type 
...
python mse_variance_gridded.py $var $var2 $var3 $var4 $var5 $var6 $var7 $var8 $var9 $SGE_TASK_ID $SGE_TASK_ID $var12 $var13 $var14 $var15
