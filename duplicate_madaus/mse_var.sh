...
#$ -V
#$ -cwd
#$ -o out_files/stats_11$JOB_NAME$TASK_ID
#$ -e err_files/stats_11$JOB_NAME$TASK_ID
#$ -t 1-8

var=$JOB_NAME #ensemble type
var2="ALT" #all variables in the netCDF, in a particular order (T2M,ALT)
...
var11=1000 #localization radius
var12=1.1 #inflation factor
...
python mse_variance_dict_EFA.py $var $var2 $var3 $var4 $var5 $var6 $var7 $SGE_TASK_ID $SGE_TASK_ID $var10 $var11 $var12
