...
end_date = datetime(2013,4,1,0)#'20130401_0000'
...
for ob_type in obs:
    ...
    dates = mt.make_datetimelist(start_date, end_date, timestep=3600*24)
        ...
        while fh <= end_hour:
            ...
            #print(ob)
                ...
                obser = Observation(value=ob_dict['ob'], time=utctime,
                                lat=ob_dict['lat'],lon=ob_dict['lon'], obtype=ob_type, localize_radius=loc_rad,
...
#                
        ...
        stats_list.append(f_h+','+str(data_dict[var][f_h]['average_mse'])+','+str(data_dict[var][f_h]['average_variance'])+','+str(data_dict[var][f_h]['average_error_variance'])+','+str(data_dict[var][f_h]['average_variance_hx_each_bias_removed'])+'\n')
