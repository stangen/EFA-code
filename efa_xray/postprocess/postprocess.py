...
def obs_assimilation_statistics(prior, obs): #post, obs):
    """
...
#ST I think to verify the updated forecasts, you need to verify against the
#observations made at the valid forecast time. ie you assimilate a 6 hour ob,
#verify against the 12,18,24,30 hour ob for each ob you assimilated at 6 hr. 