...
class Assimilation():
    ...
    def compute_ob_priors(self):
        ...
        for obnum, ob in enumerate(self.obs):
            #ST estimates the variable value of the ensemble members at the ob location
    ...
    def format_prior_state(self):
        ...
        #ST I think, through here, and estimate/interpolate, only the variable
        #that matches the ob type will be returned, which is good.
        ...
        #if self.nproc <= 1:
        #ST But I think in here, all variables are retained, just the obmeans
        #and obperts are appended to use for covariance in ensrf to apply to all
        #variables and across all times, locations. 
        
        #ST I think xbm is a horizontal row vector because mean makes it a row vector,
        #xbp is a vertical column matrix, where the columns are ensemble pertubation
